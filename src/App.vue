...
import SynthKit from './components/SynthKit.vue'
import { SynthGen } from './script/synth'
import { ref, watch, defineProps, onMounted } from 'vue'
import KickKit from './components/KickKit.vue';
import SnareKit from './components/SnareKit.vue';
