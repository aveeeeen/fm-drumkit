...
<template>
  <div class="center">
    <div @click="onChange()" @change="onChange()" class="synth-kit">
      ...
      <OscSettings :osc-settings="synthState.oscSettings" @update="event => synthState.oscSettings = event"></OscSettings>
      ...
      <div class="container">
        ...
        <div class="flex-vert gap-10">
          <div class="flex-hori gap-10">
            ...
            <input class="pitch-slider" type="range" min="0" max="8" step="1" v-model.number="synthState.pitchEnv.pitch"></input>
          </div>
          <Envelope :envelope="synthState.pitchEnv.envelope" @update="event => synthState.pitchEnv.envelope = event"></Envelope>
        </div>
      </div>
